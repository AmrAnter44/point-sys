...
export interface Permissions {
  ...
  canViewPhysio: boolean
  canCreatePhysio: boolean
  canEditPhysio: boolean
  canDeletePhysio: boolean
  ...
  // صلاحيات نقاط الولاء
  canManageLoyaltyPoints: boolean
}
...
export const DEFAULT_PERMISSIONS: Record<UserRole, Permissions> = {
  ADMIN: {
    ...
    canViewPhysio: true,
    canCreatePhysio: true,
    canEditPhysio: true,
    canDeletePhysio: true,
  ...
  COACH: {
    ...
    canViewPhysio: true, // يرى جلساته فقط
    canCreatePhysio: false,
    canEditPhysio: false,
    canDeletePhysio: false,
    canViewNutrition: true, // يرى جلساته فقط
    canCreateNutrition: false,
    canEditNutrition: false,
    canDeleteNutrition: false,
    canViewStaff: false,
...
export const PERMISSION_LABELS: Record<keyof Permissions, string> = {
  ...
  canViewPhysio: 'عرض العلاج الطبيعي',
  canCreatePhysio: 'إنشاء باقة علاج طبيعي',
  canEditPhysio: 'تعديل باقة علاج طبيعي',
  canDeletePhysio: 'حذف باقة علاج طبيعي',
  canViewNutrition: 'عرض التغذية',
  canCreateNutrition: 'إنشاء باقة تغذية',
  canEditNutrition: 'تعديل باقة تغذية',
  canDeleteNutrition: 'حذف باقة تغذية',
  ...
  canManageLoyaltyPoints: 'إدارة نقاط الولاء',
}
