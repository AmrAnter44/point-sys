    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl max-w-5xl w-full shadow-2xl max-h-[90vh] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-4 space-y-3 overflow-y-auto flex-1">
          ...
          {receipt.type === 'Points Redemption' && details.pointsUsed && (
            <div className="bg-gradient-to-r from-yellow-100 to-orange-100 rounded-lg p-4 border-2 border-yellow-300">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center bg-white p-3 rounded-lg">
                  <span className="text-gray-700 font-medium">Points Used:</span>
                ...
                {details.daysAdded && (
                  <div className="flex justify-between items-center bg-white p-3 rounded-lg">
                    <span className="text-gray-700 font-medium">Days Added:</span>
                ...
                {details.oldExpiryDate && details.newExpiryDate && (
                  <div className="bg-white p-4 rounded-lg">
                    <p className="text-center text-gray-600 font-medium mb-3">Membership Expiry Date</p>
                    <div className="flex justify-around items-center">
                      <div className="text-center">
                        <p className="text-xs text-gray-500 mb-1">Before</p>
                        <p className="font-bold text-red-600">
                          {new Date(details.oldExpiryDate).toLocaleDateString('en-US')}
                        </p>
                      </div>
                      ...
                      <div className="text-center">
                        ...
                        <p className="font-bold text-green-600">
                          {new Date(details.newExpiryDate).toLocaleDateString('en-US')}
                        </p>
                      </div>
                    </div>
                  </div>
