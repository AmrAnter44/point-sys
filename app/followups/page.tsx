...
export default function FollowUpsPage() {
  ...
  const getResultBadge = (result?: string) => {
    const badges = {
      ...
      subscribed: 'bg-orange-100 text-orange-800',
    }
  ...
  return (
    <div className="container mx-auto px-4 py-6 md:px-6" dir={direction}>
        ...
        <div className="grid grid-cols-5 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
                  ...
                  <div className="flex justify-between items-start gap-2 mb-3">
                    ...
                    <div className="flex gap-2">
                      ...
                      {!isExpired && (
                        <button
                          onClick={() => openQuickFollowUp(followUp.visitor)}
                          className="text-orange-600 hover:text-orange-800 text-xs font-medium px-2 py-1 rounded bg-orange-50 hover:bg-orange-100"
                        >
                          ➕
                        </button>
                      )}
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-2 flex-wrap">
                        ...
                        {!isExpired && (
                          <button
                            onClick={() => openQuickFollowUp(followUp.visitor)}
                            className="text-orange-600 hover:text-orange-800 text-sm font-medium px-3 py-1 rounded bg-orange-50 hover:bg-orange-100"
      ...
      {/* Quick Tips */}
      <div className="mt-4 bg-gradient-to-r from-orange-50 to-indigo-50 border-r-4 border-orange-500 p-5 rounded-lg">
