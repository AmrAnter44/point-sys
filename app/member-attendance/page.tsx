...
export default function MemberAttendancePage() {
  ...
  return (
    <div className="container mx-auto p-6" dir={direction}>
      ...
      {/* Date Range Filter */}
      <div className="bg-gradient-to-br from-white to-orange-50 p-6 rounded-xl shadow-lg mb-6 border-2 border-orange-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        <div className="bg-gradient-to-br from-orange-50 to-cyan-50 p-6 rounded-lg shadow-md border-2 border-orange-400">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-orange-700 text-sm font-semibold mb-1">{t('memberAttendance.totalAttendance')}</p>
              <p className="text-3xl font-bold text-orange-800">{totalCheckIns}</p>
            </div>
