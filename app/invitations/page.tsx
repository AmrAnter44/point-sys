...
export default function InvitationsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-6 md:px-6" dir={direction}>
                ...
                <tbody>
                  {currentInvitations.map((invitation) => (
                    <tr key={invitation.id} className="border-t hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3">
                        <span className="inline-block bg-orange-100 text-orange-800 px-2 py-1 rounded font-bold text-sm">
                          #{invitation.member.memberNumber}
                        </span>
                      </td>
                      <td className="px-4 py-3">
      ...
      {/* Note */}
      <div className="mt-6 bg-orange-50 border-r-4 border-orange-500 p-4 rounded-lg">
